...
import org.cheetah.nio.file.DirectoryStream;
...
public class RessourceFinderImage {
    ...
    public static FileInformation[] listRessources(CheetahWebserver webserver, Request request) {
        ...
        if (!webserver.isFileFolderFilesystemOnly()) {
            ...
            List<FileInformation> packages = RessourceFinderImage.getPackageFromPackage(packagePageName + packageName, webserver.getClassLoader());
            ...
            List<FileInformation> plugin = RessourceFinderImage.getFolderFromPlugin(pluginPackageName, webserver.getClassLoader());
            ...
            List<Class<?>> classes = RessourceFinderImage.getClassesFromPackage(packagePageName + packageName, webserver.getClassLoader());
            ...
            List<FileInformation> files = RessourceFinderImage.getRessourcesFromPackage(pluginPackageName, webserver.getClassLoader());
