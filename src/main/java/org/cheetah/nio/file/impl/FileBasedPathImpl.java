...
package org.cheetah.nio.file.impl;
...
import java.net.URI;
import org.cheetah.nio.file.NoSuchFileException;
...
public class FileBasedPathImpl implements Path {
  ...
  public boolean startsWith(Path path){
    return this.toAbsolutePath().toString().startsWith(path.toAbsolutePath().toString());
  }
