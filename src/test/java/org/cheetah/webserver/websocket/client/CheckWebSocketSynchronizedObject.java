 ...
 */
public class CheckWebSocketSynchronizedObject<RequestObject extends Serializable, ResponseObject extends Serializable> {

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(CheckWebSocketSynchronizedObject.class);
    ...
    private CheckWebSocketSynchronizedObject() {
    }

    public CheckWebSocketSynchronizedObject(String name, String host, int port, String URI, boolean sslEnabled, int code, String result) {
        this(name,host, port, "", "", URI, sslEnabled, false, code, result);
    }

    public CheckWebSocketSynchronizedObject(String name, String host, int port, String URI, boolean sslEnabled, boolean sslEnforceValidation, int code, String result) {
        this(name,host, port, "", "", URI, sslEnabled, sslEnforceValidation, code, result);
    }

    public CheckWebSocketSynchronizedObject(String name, String host, int port, String username, String password, String URI, boolean sslEnabled, int code, String result) {
        this(name,host, port, username, password, URI, sslEnabled, false, code, result);
    }

    public CheckWebSocketSynchronizedObject(String name, String host, int port, String username, String password, String URI, boolean sslEnabled, boolean sslEnforceValidation, int code, String result) {
        this.host = host;
        this.port = port;
        ...
        try {
            ...
            if (socket != null) {
                ...
                if (response.getCode() == 101) {
                    ...
                    responseResult = (String) synchronizedSendObject((RequestObject) result);
                }
