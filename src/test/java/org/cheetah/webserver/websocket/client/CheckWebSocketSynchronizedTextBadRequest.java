...
import static org.cheetah.webserver.CheetahWebserverTest.charset;

/**
 *
 * @author Philippe Schweitzer
 */
public class CheckWebSocketSynchronizedTextBadRequest<RequestObject extends Serializable, ResponseObject extends Serializable> {

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(CheckWebSocketSynchronizedTextBadRequest.class);
    ...
    private CheckWebSocketSynchronizedTextBadRequest() {
    }

    public CheckWebSocketSynchronizedTextBadRequest(String name, String host, int port, String URI, boolean sslEnabled, int code, String result) {
        this(name,host, port, "", "", URI, sslEnabled, false, code, result);
    }

    public CheckWebSocketSynchronizedTextBadRequest(String name, String host, int port, String URI, boolean sslEnabled, boolean sslEnforceValidation, int code, String result) {
        this(name,host, port, "", "", URI, sslEnabled, sslEnforceValidation, code, result);
    }

    public CheckWebSocketSynchronizedTextBadRequest(String name, String host, int port, String username, String password, String URI, boolean sslEnabled, int code, String result) {
        this(name,host, port, username, password, URI, sslEnabled, false, code, result);
    }

    public CheckWebSocketSynchronizedTextBadRequest(String name, String host, int port, String username, String password, String URI, boolean sslEnabled, boolean sslEnforceValidation, int code, String result) {
        this.host = host;
        this.port = port;
...
//        System.out.println("10- CheckWebSocketSynchronizedTextBadRequest " + host);
...
*/                    
     ...
     //               System.out.println("10- CheckWebSocketSynchronizedTextBadRequest 1");
                    if (response.isFinished()) {
     //               System.out.println("10- CheckWebSocketSynchronizedTextBadRequest 1 FINISH");
                        break;
                    }
                }
