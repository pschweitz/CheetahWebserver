 ...
 */
public class CheckWebSocketSynchronizedText<RequestObject extends Serializable, ResponseObject extends Serializable> {

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(CheckWebSocketSynchronizedText.class);
    ...
    private CheckWebSocketSynchronizedText() {
    }

    public CheckWebSocketSynchronizedText(String name, String host, int port, String URI, boolean sslEnabled, int code, String result) throws SSLHandshakeException {
        this(name, host, port, "", "", URI, sslEnabled, false, code, result);
    }

    public CheckWebSocketSynchronizedText(String name, String host, int port, String URI, boolean sslEnabled, boolean sslEnforceValidation, int code, String result) throws SSLHandshakeException {
        this(name, host, port, "", "", URI, sslEnabled, sslEnforceValidation, code, result);
    }

    public CheckWebSocketSynchronizedText(String name, String host, int port, String username, String password, String URI, boolean sslEnabled, int code, String result) throws SSLHandshakeException {
        this(name, host, port, username, password, URI, sslEnabled, false, code, result);
    }

    public CheckWebSocketSynchronizedText(String name, String host, int port, String username, String password, String URI, boolean sslEnabled, boolean sslEnforceValidation, int code, String result) throws SSLHandshakeException {
        this.host = host;
        this.port = port;
    ...
    protected void createConnection() throws SSLHandshakeException {
        ...
        try {
            ...
            if (socket != null) {
                ...
                } else if (responseResult.length() >= result.length()) {
            ...
            if (SSLHandshakeException.class.isAssignableFrom(e.getClass())) {
